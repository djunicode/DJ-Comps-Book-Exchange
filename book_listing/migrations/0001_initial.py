# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-08 13:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication', models.CharField(choices=[('Techmax', 'Techmax'), ('Technical', 'Technical'), ('Reference Book', 'Reference Book'), ('Easy Solution', 'Easy Solution'), ('Textbook', 'Textbook')], default='Techmax', max_length=30)),
                ('uploaded_by', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
